...
def generate_answer(question):
    prompt = (
        f"คุณเป็นผู้ช่วยแนะนำเพลงตามอารมณ์ของผู้ใช้ เช่น รัก เศร้า เหงา เครียด เบื่อ ดีใจ เป็นต้น "
        f"แม้คำอารมณ์นั้นจะเป็นภาษาไทยหรือภาษาอังกฤษก็ตาม\n\n"
        f"ตอนนี้ผู้ใช้บอกว่า: '{question}'\n\n"
        f"กรุณาแนะนำเพลง 3 เพลงที่เหมาะกับอารมณ์นี้ โดยตอบกลับตาม format นี้เท่านั้น (ห้ามเขียนอย่างอื่น):\n\n"
        f"เพลง: <ชื่อเพลง>\nเหตุผล: <คำอธิบายสั้นๆ 1-2 บรรทัด>\n\n"
        f"ทำแบบนี้ 3 ชุด ห้ามเกิน ห้ามเขียน prefix หรือข้อความอื่นนอกจาก format นี้"
    )
